    ...
    <div class="row">
      <div id="sp-logo" class="col-xs-8 col-sm-3 col-md-2">
        <div class="sp-column "><a class="logo" href="/">
          <h1 style="color:#913334;">drinkArt商城</h1>
          </a></div>
      </div>
        ...
        <div class="sp-column ">
          <ul>
            <li><a class="btn btn-primary btn-submit-item hidden-sm hidden-xs" href="/login">Start Selling</a></li>
              ...
              <li><a class="btn btn-link btn-login visible-sm visible-xs" href="#"><i class="fa fa-bars" style="background:url('../../images/user.png')no-repeat;margin-top:80%;width: 130%;height: 90%;"></i></a></li>
...
<div class="shoppingcart" style="width:8%;height:4%;position:fixed;right:10%;bottom:2%;z-index:100;">
                      ...
                      <div class="portfolio-items isotopeWrapper clearfix" id="3">
						...
						<article class="col-md-4 isotopeItem webdesign" style="border:1px solid #000000;border-radius:10px;background-color:#ffffff;padding-left:0;padding-right:0;">
						  ...
						  <div class="shop-itemdetail"style="">
							...
							<p>价格 :<span>￥</span><span class="shop-itemprice">10000.00</span></p>
						  </div>
                        </article>
						...
						<article class="col-md-4 isotopeItem webdesign" style="border:1px solid #000000;border-radius:10px;background-color:#ffffff;padding-left:0;padding-right:0;">
						  ...
						  <div class="shop-itemdetail"style="">
							...
							<p>价格 :<span>￥</span><span class="shop-itemprice">2000.00</span></p>
						  </div>
                        </article>
						...
						<article class="col-md-4 isotopeItem webdesign" style="border:1px solid #000000;border-radius:10px;background-color:#ffffff;padding-left:0;padding-right:0;">
						  ...
						  <div class="shop-itemdetail"style="">
							...
							<p>作者 :<span>林杰</span></p>
							<p>价格 :<span>￥</span><span class="shop-itemprice">2400.00</span></p>
						  </div>
                        </article>
  ...
  <div class="offcanvas-menu" style="background-color:#f3acb3;"> <a href="#" class="close-offcanvas"><i class="fa fa-remove" style="background:url('../../images/close.png');width:65%;height:65%;margin-left:-18%;margin-top:13%;"></i></a>
