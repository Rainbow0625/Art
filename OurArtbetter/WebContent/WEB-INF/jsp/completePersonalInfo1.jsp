							...
							<div class="box registration">
								<form id="member-registration"
									...
									<div class="form-group">
										<div class="text-center" style="font-size: 25px;">修改个人信息</div>
									</div>
									<div class="form-group">
										<div class="group-control" style="font-size:15px;">
											<span>手机号 ：</span><span><!---<%=session.getAttribute("userName")%>-->18106989999</span>
										</div>
									</div>

									<div class="form-group">
										<div class="group-control">
											<label style="float:left;margin-top:2%;">昵称 :</label><input type="text" name="nickName" id="" value="" style="float:left;width:60%;margin-left:10%;height:32px;min-height:32px;" autofocus="">
										</div>
									</div>
									...
									<div class="form-group">
										<div class="group-control" name="gender">
											...
											<label style="margin-left:10%;"> <input type="radio" name=""
									...
									<div class="form-group">
										<div class="parentCls group-control">
											<label style="float:left;margin-top:2%;">邮箱 :</label>
											<input type="text" name="email" class="inputElem"
												id="mailbox" value="" style="float:left;width:60%;margin-left:10%;height:32px;min-height:32px;"/>
									...
									<div class="form-group">
										<div class="group-control">
										<label style="float:left;margin-top:2%;">邮编 :</label>
											<input type="text" name="code" class="inputElem"
												id="mailcode" value="" style="float:left;width:60%;margin-left:10%;height:32px;min-height:32px;"/>
									...
									<div class="form-group">
										<div class="group-control">
										<label style="float:left;margin-top:2%;">地址 :</label>
											<input type="text" id="city" name="address" style="float:left;width:60%;margin-left:10%;height:32px;min-height:32px;"/>
										</div>
									</div>

									<div class="form-group">
										<div class="group-control">
										<label style="float:left;margin-top:2%;">生日 :</label>
											<div class="input-append date" id="datetimepicker"
												data-date="" data-date-format="dd-mm-yyyy">
												<input class="span2" style="float:left;width:60%;margin-left:10%;height:32px;min-height:32px;" type="text" id="infodate"
													name="birthday"/>
												<!--这个需要后台设置value为当前时间-->
