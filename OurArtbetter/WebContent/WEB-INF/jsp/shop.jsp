...
<div class="sppb-addon sppb-addon-items items-featured ">
  ...
  <section id="sp-main-body">
    <div class="container">
			  ...
			  <div class="product-details">
					  ...
					  <div class="orderitem">
					   <div class="productitem">
                        <div class="row">
							<div class="col-xs-12">
							   <figure class="member-photo"><img src="images/member4.jpg"/></figure>
							</div>
							<div class="col-xs-12">
							   <ul>
                                    <li><strong style="color:#000000;">电话号码</strong>: 18106989735</li>
                                    <li><strong style="color:#000000;">邮箱</strong>: 1882849305@qq.com</li>
                                    <li><strong style="color:#000000;">个人介绍</strong>:白玉明，满族，斋号金名轩。河北承德人，职业书法家，现居北京。中国民主同盟盟员，新加坡艺术协会副主席、人民日报《民生周刊》执行主编、人民日报《艺术》编委、中国民族画院副秘书长、东交民巷艺术馆执行馆长、世界华人实力书画家协会理事、大千收藏加盟书法家、白氏书法太极格发明人。著名书法家刘炳森先生、欧伯达先生入室弟子。擅行、草、隶诸体及篆刻。</li>
                                  </ul>
							</div>
							</div>
                        </div>
									...
									<div class="orderitem">
					  <div style="width:100%;height:20px;"><p style="display:inline;float:left;color:#000000;font-size:16px;font-weight:600;">他的商品 : </p>
							
							 <a href="#" style="float:right;color:#777;font-size:8px;display:inline;">查看更多>></a>
							</div>
					   <div class="productitem">
                        <div class="row">
							<div class="col-xs-6">
							  <img src="images/thing1.jpg"/>
								...
								<div class="col-xs-6">
							  <img src="images/thing2.jpg"/>
							</div>
								<div class="col-xs-6">
							  <img src="images/thing3.jpg"/>
							</div>
								<div class="col-xs-6">
							  <img src="images/thing2.jpg"/>
							</div>
	 ...
	 <div style="width:100%;height:20px;"><p style="display:inline;float:left;color:#000000;font-size:16px;font-weight:600;">他的作品 : </p>
					   ...
					   <div class="productitem">
                        <div class="row">
						 ...
						 <div style="width:100%;height:20px;"><p style="display:inline;float:left;color:#000000;font-size:16px;font-weight:600;">他的定制 : </p>
								 
						<input type="button" value="找他定制" style="display:block;float:right;color:#ffffff;border-radius:2px;background-color:#8f1c22;border:1px solid #8f1c22;width:23%;height:28px;font-size:16px;"/>
							</div>
					   <div class="productitem">
                        <div class="row">
							<div class="col-xs-6">
