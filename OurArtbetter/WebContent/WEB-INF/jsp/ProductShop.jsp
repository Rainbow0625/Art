...
<div class="row mar-bot40"style="background-color:#ffffff;">
                  <div class="col-md-offset-3 col-md-6" style="padding:2% 8%;">
                    <div class="item-type" style="background-color:#e5e5e5;border-radius:3px;width:25%;text-align:center;border-bottom:1px solid #e5e5e5;margin-left:2%;" id="item-type">
					   <span id="showitemtype">商品分类</span>
					</div>
					<div class="item-typedrop" style="z-index:100;display:block;width:100%;height:20%;display:none;" id="item-typedrop">
				  <div class="col-sm-4 col-xs-4"><span class="itemstyle">全部分类</span></div>
				  <div class="col-sm-4 col-xs-4"><span class="itemstyle">玉石</span></div>
				  <div class="col-sm-4 col-xs-4"><span class="itemstyle">版画</span></div>
				  <div class="col-sm-4 col-xs-4"><span class="itemstyle">油画</span></div>
				  <div class="col-sm-4 col-xs-4"><span class="itemstyle">水墨</span></div>
				  <div class="col-sm-4 col-xs-4"><span class="itemstyle">素描</span></div>
				  <div class="col-sm-4 col-xs-4"><span class="itemstyle">书画</span></div>
				  <div class="col-sm-4 col-xs-4"><span class="itemstyle">陶瓷</span></div>
				  <div class="col-sm-4 col-xs-4"><span class="itemstyle">雕塑</span></div>
                      ...
                      <div class="portfolio-items isotopeWrapper clearfix" id="3">
						...
						<article class="col-md-4 isotopeItem webdesign" style="border:1px solid #000000;border-radius:10px;background-color:#ffffff;padding-left:0;padding-right:0;">
                          <div class="portfolio-item" style="width:100%;height:85%;"> 
						   <img src="images/thing1.jpg" alt="找不到图片" style="border:1px solid #d6d3d3;border-radius:10px;"/>
						  ...
						  <div class="shop-itemdetail"style="">
						    <p style="color:#000000;">晨</p>
							<p>作者 :<span>刘东旭</span></p>
							<p>价格 :<span>￥</span><span class="shop-itemprice">10000.00</span><i class="icon"></i></p>
						  </div>
                        </article>
						
						<article class="col-md-4 isotopeItem webdesign" style="border:1px solid #000000;border-radius:10px;background-color:#ffffff;padding-left:0;padding-right:0;">
                          <div class="portfolio-item" style="width:100%;height:85%;"> 
						   <img src="images/thing2.jpg" alt="找不到图片" style="border:1px solid #d6d3d3;border-radius:10px;"/>
                            <div class="portfolio-desc align-center">
                              <div class="folio-info">
                                <h5><a href="#">Portfolio name</a></h5>
                                <a href="img/portfolio/art1.jpg" class="fancybox"><i class="fa fa-plus fa-2x"></i></a> </div>
						  ...
						  <div class="shop-itemdetail"style="">
						    <p style="color:#000000;">范思哲香水，骷髅和苹果时钟静物画</p>
							<p>作者 :<span>彼得·克莱兹(pieter claesz)</span></p>
							<p>价格 :<span>￥</span><span class="shop-itemprice">2000.00</span><i class="icon"></i></p>
						  </div>
                        </article>
						
                       		<article class="col-md-4 isotopeItem webdesign" style="border:1px solid #000000;border-radius:10px;background-color:#ffffff;padding-left:0;padding-right:0;">
                          <div class="portfolio-item" style="width:100%;height:85%;"> 
						   <img src="images/thing3.jpg" alt="找不到图片" style="border:1px solid #d6d3d3;border-radius:10px;"/>
                            <div class="portfolio-desc align-center">
                              <div class="folio-info">
                                <h5><a href="#">Portfolio name</a></h5>
                                <a href="img/portfolio/art1.jpg" class="fancybox"><i class="fa fa-plus fa-2x"></i></a> </div>
						...
						<article class="col-md-4 isotopeItem webdesign" style="border:1px solid #000000;border-radius:10px;background-color:#ffffff;padding-left:0;padding-right:0;">
						  ...
						  <div class="shop-itemdetail"style="">
							...
							<p>价格 :<span>￥</span><span class="shop-itemprice">2000.00</span><i class="icon"></i></p>
                       		...
                       		<article class="col-md-4 isotopeItem webdesign" style="border:1px solid #000000;border-radius:10px;background-color:#ffffff;padding-left:0;padding-right:0;">
                          <div class="portfolio-item" style="width:100%;height:85%;"> 
						   <img src="images/thing4.jpg" alt="找不到图片" style="border:1px solid #d6d3d3;border-radius:10px;"/>
                            <div class="portfolio-desc align-center">
                              <div class="folio-info">
                                <h5><a href="#">Portfolio name</a></h5>
                                <a href="img/portfolio/art1.jpg" class="fancybox"><i class="fa fa-plus fa-2x"></i></a> </div>
						  ...
						  <div class="shop-itemdetail"style="">
						    <p style="color:#000000;">和谐</p>
							<p>作者 :<span>林杰</span></p>
							<p>价格 :<span>￥</span><span class="shop-itemprice">2400.00</span><i class="icon"></i></p>
						  </div>
                        </article>
