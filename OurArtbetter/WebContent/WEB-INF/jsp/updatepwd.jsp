...
._citys1 a { width: 53px; height: 35px; display: inline-block; background-color: #f5f5f5; color: #666; margin-left: 3px; margin-top: 3px; line-height: 35px; text-align: center; cursor: pointer; font-size: 13px; overflow: hidden; }
...
<form id="member-registration" action="/OurArtbetter/updatePassword" method="post" class="form-validate" enctype="multipart/form-data">
<div class="form-group">
<div class="text-center" style="font-size:25px;">修改密码</div>
</div>


<div class="form-group">
   <div class="group-control">
        <input type="password" name="password"  value=""  size="10" placeholder="输入原密码"  autofocus="" id="pwdold"/>
    </div>
...
<div class="form-group">
   <div class="group-control">
        <input type="password" name="newPassword"  value=""  size="10" placeholder="输入新密码"  autofocus="" id="pwdnew"/>
    </div>
...
<div class="form-group">
   <div class="group-control">
        <input type="password" name="confirmPassword"  value=""  size="10" placeholder="再次输入新密码"  autofocus="" id="pwdnewagain"/>
    </div>
	<div class="tip-control" id="newpwd-test">
					    <span><i></i></span>
					  </div>
                    </div>
...
var newone=document.getElementById('pwdnew').value;
var newagain=document.getElementById('pwdnewagain').value;

        if(newone==newagain)
          document.getElementById('newpwd-test').innerHTML="";
		else
        {
          document.getElementById('newpwd-test').innerHTML="两次输入密码不一致";
