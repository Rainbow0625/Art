...
import com.art.shop.utils.PaymentUtil;
...
public class OrderController {
	...
	public String payOrder(@RequestParam Integer oid,@RequestParam String addr,
	...
	public String callBack(@RequestParam Integer r6_Order,
			@RequestParam("r3_Amt") Integer r3_Amt,Map<String,Object> map){
		// 修改订单的状态:
