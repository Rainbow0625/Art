        ...
        <div class="sp-column ">
          <div class='sp-megamenu-wrapper'>
            <ul class="sp-megamenu-parent menu-fade hidden-xs">
              <li class="sp-menu-item "><a  href="/" >首页</a></li>
              <li class="sp-menu-item "><a  href="/free-templates" >艺术资讯</a></li>
              <li class="sp-menu-item current-item active"><a  href="artistList" >签约艺术家</a></li>
...
<section  class="sppb-section section-intro" style="margin:0px;padding:70px 0;">
                      ...
                      <div class="sppb-addon-container" style="">
                        <div class="sppb-addon sppb-addon-items items-featured ">
                          <div class="sppb-addon-content">
                            <div class="row">
                              <div class="col-sm-6"><img src="../../images/member4.jpg" alt="Fairness - One Page Responsive Bootstrap Charity Template" width="100%"/></div>
                              <div class="col-sm-6">
                                <div class="featured-content">
                                
                                  <h2 itemprop="name"><a href="/item/1525131-fairness-one-page-responsive-bootstrap-charity-template" itemprop="url">白玉明</a></h2>
                                  <ul>
                                    <li><strong>电话号码</strong>: 18106989735</li>
                                    <li><strong>邮箱</strong>: 1882849305@qq.com</li>
                                    <li><strong>个人介绍</strong>:白玉明，满族，斋号金名轩。河北承德人，职业书法家，现居北京。中国民主同盟盟员，新加坡艺术协会副主席、人民日报《民生周刊》执行主编、人民日报《艺术》编委、中国民族画院副秘书长、东交民巷艺术馆执行馆长、世界华人实力书画家协会理事、大千收藏加盟书法家、白氏书法太极格发明人。著名书法家刘炳森先生、欧伯达先生入室弟子。擅行、草、隶诸体及篆刻。</li>
                                  </ul>
